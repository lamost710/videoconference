...
namespace MSR.LST.ConferenceXP
{
    public class FMain : System.Windows.Forms.Form
    {
        ...
        private CSharpWin.SplitContainerEx splitContainerMain;
        private TabPage VideoList;
        private TabPage UserList;
        private FlowLayoutPanel videoPanal;
        private TabControl tabControl1;
        internal  MenuItem LeaveVenue;
        ...
        private void InitializeComponent()
        {
            ...
            this.videoPanal = new System.Windows.Forms.FlowLayoutPanel();
            ...
            this.LeaveVenue = new System.Windows.Forms.MenuItem();
            this.toolTip = new System.Windows.Forms.ToolTip(this.components);
            this.statusBarTimer = new System.Windows.Forms.Timer(this.components);
            this.splitContainerMain = new CSharpWin.SplitContainerEx();
            ...
            this.tabControl1.Controls.Add(this.VideoList);
            this.tabControl1.Controls.Add(this.UserList);
            ...
            // VideoList
            // 
            this.VideoList.AllowDrop = true;
            this.VideoList.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
            this.VideoList.Controls.Add(this.videoPanal);
            this.VideoList.Location = new System.Drawing.Point(4, 4);
            this.VideoList.Name = "VideoList";
            this.VideoList.Padding = new System.Windows.Forms.Padding(3);
            this.VideoList.RightToLeft = System.Windows.Forms.RightToLeft.No;
            this.VideoList.Size = new System.Drawing.Size(88, 72);
            this.VideoList.TabIndex = 0;
            this.VideoList.Text = "视频窗口";
            this.VideoList.UseVisualStyleBackColor = true;
            // 
            // videoPanal
            // 
            this.videoPanal.AllowDrop = true;
            this.videoPanal.Dock = System.Windows.Forms.DockStyle.Fill;
            this.videoPanal.FlowDirection = System.Windows.Forms.FlowDirection.TopDown;
            this.videoPanal.Location = new System.Drawing.Point(3, 3);
            this.videoPanal.Name = "videoPanal";
            this.videoPanal.Size = new System.Drawing.Size(80, 64);
            this.videoPanal.TabIndex = 0;
            // 
            // UserList
            // 
            ...
            this.UserList.Size = new System.Drawing.Size(88, 72);
            ...
            this.listView.Size = new System.Drawing.Size(677, 300);
            ...
            this.imageList.ImageSize = new System.Drawing.Size(88, 88);
            ...
            this.statusBar.Size = new System.Drawing.Size(677, 20);
            ...
            // LeaveVenue
            // 
            this.LeaveVenue.Index = 3;
            this.LeaveVenue.Text = "";
            this.LeaveVenue.Visible = false;
            this.LeaveVenue.Click += new System.EventHandler(this.LeaveVenue_Click);
            // 
            // toolTip
            // 
            ...
            // splitContainerMain
            // 
            this.splitContainerMain.CollapsePanel = CSharpWin.CollapsePanel.Panel2;
            ...
            this.splitContainerMain.Size = new System.Drawing.Size(677, 300);
            ...
            // splitContainer1
            // 
            this.splitContainer1.CollapsePanel = CSharpWin.CollapsePanel.Panel2;
            ...
            this.splitContainer1.Size = new System.Drawing.Size(677, 300);
            ...
            this.MinimumSize = new System.Drawing.Size(192, 258);
            this.Name = "FMain";
        ...
        {
            Control ctr =(Control) e.Data.GetData(typeof(FAudioVideo));
            if (ctr == null)
            {
                ctr = (Control)e.Data.GetData(typeof(MSR.LST.ConferenceXP.PresentationCapabilityFMain));
            }
            Control ctr2 = this.splitContainer1.Panel1.Controls[0];
            this.videoPanal.Controls.Remove(ctr);
            this.splitContainer1.Panel1.Controls.Remove(ctr2);
            //if (ctr is FAudioVideo)
            ctr.Dock = DockStyle.Fill;
            //ctr.Size = new System.Drawing.Size(1100, 660);

            ctr2.Dock = DockStyle.None;
            ctr2.Size = new System.Drawing.Size(230, 200);
            this.splitContainer1.Panel1.Controls.Add(ctr);
           
            this.videoPanal.Controls.Add(ctr2);
        ...
        //    this.videoPanal.DoDragDrop(ctr, DragDropEffects.All);
        //}
        #endregion
        ...
        private void FMain_Load(object sender, System.EventArgs e)
        {
            ...
            this.LeaveVenue.Text = Strings.LeaveVenue;
            ...
            Conference.CapabilityPlaying+=new CapabilityPlayingEventHandler(OnCapabilityPlaying);
            ...
            DisplayRTDocumentViewers();//rtdDoc
        ...
        private void FMain_Closing(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            if (this.LeaveVenue.Visible)
            {
                this.LeaveVenue.PerformClick();
            }
        ...
        /// 参加会议
        /// </summary>
        /// <param name="venueToJoin"></param>
        /// <param name="sendAV"></param>
        private void JoinVenue(Venue venueToJoin, bool sendAV)
        {
            ...
            if (Conference.Participants[0].Role== ParticipantRole.Professor)//根据角色来创建白板
            {
                ICapabilitySender csp = Conference.CreateCapabilitySender("Presentation");
                ICapabilitySender csc = Conference.CreateCapabilitySender("Chat");
            }
        }
        ...
        private void InVenueUIState()
        {
            ...
            this.splitContainer1.Panel1.Controls.Remove(listView);
            this.splitContainerMain.Panel2Collapsed = false;
            this.UserList.Controls.Add(this.listView);
        ...
        {
            Bitmap icon = new Bitmap(88,88, System.Drawing.Imaging.PixelFormat.Format24bppRgb);
            using (Graphics g = Graphics.FromImage(icon))
            {
                g.FillRectangle(new SolidBrush(listView.BackColor), 0, 0, 88, 88);
                g.InterpolationMode = System.Drawing.Drawing2D.InterpolationMode.HighQualityBicubic;
                g.DrawImage(masterImage, 0, 0, 88, 88);
        ...
        private void OnParticipantAdded(IParticipant p)
        {
            if (Conference.ActiveVenue != null) // We may have already left the venue and this is coming in late because it's invoked on the form thread and comes in via the message loop
            {
                ...
                RefreshImages();
                DisplayParticipantCount();
                if ((p.Role != ParticipantRole.Professor) && (Conference.LocalParticipant.Role== ParticipantRole.Professor))
                     MSR.LST.ConferenceXP.PresentationCapabilityFMain.IsRsend = true;
            }
        }
        ...
        private void OnCapabilityPlaying(object conference,CapabilityEventArgs cea)
        {
            if (Conference.ActiveVenue != null) // We may have already left the venue and this is coming in late because it's invoked on the form thread and comes in via the message loop
            {
                RefreshImages();
                ...
                if (cea.Capability is AudioCapability)
                {
                    ...
                    Control frm = (FAudioVideo)((AudioCapability)cea.Capability).Form;
                    //frm.MouseDown+=frm_MouseDown;
                    frm.Size = new System.Drawing.Size(230, 200);
                    frm.AllowDrop = true; 
                    frm.DragEnter += Panel1_DragEnter;
                    frm.DragDrop += Panel1_DragDrop;
                    this.videoPanal.Controls.Add(frm);
                ...
                if (cea.Capability is VideoCapability)
                {
                    ...
                    Control frm = (FAudioVideo)((VideoCapability)cea.Capability).Form;
                    frm.Size = new System.Drawing.Size(230, 200);
                    frm.AllowDrop = true;
                    //frm.MouseDown+=frm_MouseDown;
                    frm.DragEnter += Panel1_DragEnter;
                ...
                if (cea.Capability.Name == "ConferenceXP 演示文稿")
                {
                    Control frm = (Control)((Capability)cea.Capability).Form;
                    //this.splitContainerMain.Panel1.Controls.Clear();
                    //frm.Size = new System.Drawing.Size(1100,660);
                    frm.AllowDrop = true;
        ...
        private void menuActionsDiagnostics_Click(object sender, EventArgs e) {
            ...
            if (Conference.ActiveVenue != null) {
                ...
                string venueMoniker = Conference.ActiveVenue.Name + "#" + Conference.ActiveVenue.EndPoint.Address.ToString();
                diagnosticsWebServiceQuery += "?venue=" + System.Net.WebUtility.HtmlEncode(venueMoniker); 
            }
        ...
        private void contextParticipant_Popup(object sender, System.EventArgs e)
        {
            ...
            if (lvi.Tag is Participant)
            {
                ...
                foreach (ICapabilityViewer cv in p.Capabilities)
                {
                    string menuText;
                    if (cv.IsPlaying)
                        if (cv is VideoCapability)
                            menuText = "关闭视频";
                        else if (cv is AudioCapability)
                            menuText = "关闭麦克风";
                        else
                            menuText = "关闭白板";
                    //menuText = string.Format(CultureInfo.CurrentCulture, Strings.StopNamePayloadType, cv.Name, 
                    //    cv.PayloadType.ToString());
                    //menuText = string.Format(CultureInfo.CurrentCulture, Strings.StopNamePayloadType, 
                    //    cv.PayloadType.ToString());
        ...
        internal void LeaveConference()
        {
            ...
            this.UserList.Controls.Remove(listView);
            this.videoPanal.Controls.Clear();
            this.splitContainerMain.Panel2Collapsed = true;
            ...
            DisplayVenues();
            this.splitContainer1.Panel1.Controls.Add(listView);
            Cursor.Current = Cursors.Default;
        }
        ...
        private void listView_ItemActivate(object sender, System.EventArgs e)
        {
            ...
            if (lvi.Tag is Venue)
            {
                if (MessageBox.Show("您是会议主持？","", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    Conference.LocalParticipant.Role = ParticipantRole.Professor;
                }
        ...
        private void LeaveVenue_Click(object sender, EventArgs e)
        {
            LeaveConference();
            Conference.LocalParticipant.Role = ParticipantRole.Other;
        }
