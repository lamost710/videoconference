...
namespace MSR.LST.ConferenceXP
{
    ...
    public class Capability : ICapability, IDisposable
    {
        ...
        protected System.Windows.Forms.UserControl form = null;
        ...
        public System.Windows.Forms.UserControl Form
        {
            get{return form;}
        }
        ...
        private void _CreateForm()
        {
            ...
            form = (System.Windows.Forms.UserControl)htFormTypes[formType];
            if (form == null)
            {
                // Instantiate a new form
                form = (System.Windows.Forms.UserControl)Activator.CreateInstance(formType);
                htFormTypes.Add(formType, (CapabilityControl)form);
            ...
            ((CapabilityControl)form).AddCapability(this);
        ...
        private void _CloseForm()
        {
            ...
            CapabilityControl capForm = (CapabilityControl)htFormTypes[formType];
            if(capForm == null)
            {
